...
def run_nlp_pipeline() -> bool:
    ...
    try:
        pipeline = NLPInferencePipeline(
            ...
            disease_mapping_path=Path("data/processed/disease_mapping.json"),
        )
    except Exception as e:
...
pathlib.Path("scripts/verify_pipelines.py").write_text(VERIFY, encoding="utf-8")
print("scripts/verify_pipelines.py written OK")
